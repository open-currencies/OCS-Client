#ifndef REFEREEAPPLICATIONW_H
#define REFEREEAPPLICATIONW_H
...
class RefereeApplicationW : Fl_Window
{
public:
    RefereeApplicationW(list<Fl_Window*> *s, InternalThread *i, string l);
    ~RefereeApplicationW();
protected:
private:
